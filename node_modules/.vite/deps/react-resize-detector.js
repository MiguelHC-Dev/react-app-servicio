...
function useResizeDetector({ skipOnMount = false, refreshMode, refreshRate = 1e3, refreshOptions, handleWidth = true, handleHeight = true, targetRef, observerOptions, onResize } = {}) {
  ...
  const [refElement, setRefElement] = (0, import_react.useState)((targetRef === null || targetRef === void 0 ? void 0 : targetRef.current) || null);
  if (targetRef) {
    setTimeout(() => {
  ...
  const refProxy = (0, import_react.useMemo)(() => new Proxy((node) => {
    if (node !== refElement) {
      setRefElement(node);
    }
  }, {
  ...
  const shouldSetSize = (0, import_react.useCallback)((prevSize, nextSize) => {
